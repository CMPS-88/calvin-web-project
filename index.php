<?php include 'include/header.php';
    ...
    <section class="banner_part">
        <div class="container">
            <div style="background-image: url('fff.png');">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-10">
                    <div class="banner_text text-center">
                        <div class="banner_text_iner">
                            <h1> Motor Mahasiswa</h1>
                            <p>Cari motor buat kuliahan?, ya Motor Mahasiswa aja</p>
                            <a href="katalog.php" class="btn_1">Kuy!</a>
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section_tittle text-center">
                        <h2>Top Motor Mahasiswa</h2>
                        <p>Setiap mahasiswa memiliki kebutuhan dan keinginan dari motor yang ingin digunakan.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <a href="katalog.php" class="btn_1 text-cnter">Tampilkan Lebih Banyak</a>
            </div>
        </div>
    </section>
    <!--top place end-->
    ...
    <section class="hotel_list section_padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section_tittle text-center">
                        <h2>Motor Paling Diminati</h2>
                        <p>Daftar motor paling dicari dan terlaris.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="img/ind/images (2).jpg " alt="">
                        ...
                        <div class="hotel_text_iner">
                            ...
                            <p>Surat Lengkap,Pajak Hidup</p>
                            <h5>Harga <span>Rp.9.000.000</span></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="img/ind/images (1).jpg" alt="">
                        <div class="hover_text">
                            <div class="hotel_social_icon">
                                <ul>
                                    <li><a href="#"><i class="ti-facebook"></i></a></li>
                        ...
                        <div class="hotel_text_iner">
                            ...
                            <p>Surat Lengkap,Pajak Hidup</p>
                            <h5>Harga <span>Rp.8.000.000</span></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="img/ind/images (3).jpg" alt="">
                        <div class="hover_text">
                            <div class="hover_text">
                                <div class="hotel_social_icon">
                                    <ul>
                        ...
                        <div class="hotel_text_iner">
                            ...
                            <p>Surabaya, Jawa Timur</p>
                            <p>Surat Lengkap,Pajak Hidup</p>
                            <h5>Harga <span>Rp.25.500.000</span></h5>
                        </div>
                    </div>
                </div>
            </div>
